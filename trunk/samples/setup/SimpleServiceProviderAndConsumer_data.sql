...
Insert   [AppVariable]   (AppVariableName,AppCode,Environment_id,Value,Description)      Values   ('NIntegrate.Query.IQueryService, NIntegrate.Query, Version=0.7.0.1, Culture=neutral, PublicKeyToken=e2b9e2165dbdd5e6','SP_SSP',1,'NIntegrate.Query.Command.QueryService, NIntegrate.Query.Command, Version=0.7.0.1, Culture=neutral, PublicKeyToken=e2b9e2165dbdd5e6',NULL)
...
Insert   [Service]   (ServiceName,AppCode,ServiceCategory_id,ServiceBehavior_id,ServiceHostType_id,HostXML)      Values   ('NIntegrate.Query.IQueryService, NIntegrate.Query, Version=0.7.0.1, Culture=neutral, PublicKeyToken=e2b9e2165dbdd5e6','SP_SSP',1,NULL,1,NULL)
